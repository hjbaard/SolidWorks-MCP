...
| M4 | revolve (cylinder/cone), shell, hole, fillet/chamfer (axis or index selection), geometry inspection | 🚧 ongoing |
...
- Geometry so far: **boxes**, **cylinders/cones** (revolve), **through-holes**,
  **fillets**, **chamfers**, **shells**, plus geometry **inspection**
  (`list_faces`/`list_edges`). Next: general revolve profiles, patterns
  (linear/circular), mirror, equations, generic sketch primitives.
